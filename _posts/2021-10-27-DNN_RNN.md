...
read: 6
description: An introduction to dense neural networks (DNN) and recurrent neural networks (RNN)
...
This post aims to:
- describe the dense neural network (DNN)
