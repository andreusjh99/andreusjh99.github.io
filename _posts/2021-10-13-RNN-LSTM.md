...
This post describes:
- the basic structure of an [RNN](#RNN)
...
<div class="math">
\begin{align}
    \text{P}(y_t = a|\mathbf{x}_{1:t}) &= \text{softmax}(\mathbf{W}_{hy} \mathbf{h}_t + \mathbf{b}_{hy})_a \, \forall \, a \in \mathcal{A} \label{eq: LSTM 6}
\end{align}
</div>
<p>
...
\begin{align}
    ...
    \text{P}(y_t = a|\mathbf{x}_{1:T}) &= \text{softmax}(\mathbf{W}_{hy} \mathbf{h}_t + \mathbf{b}_{hy})_a \, \forall \, a \in \mathcal{A}  \label{eq: BLSTM 4}
\end{align} 
</div>
<p>
...
\begin{align}
    ...
    \text{P}(y_t = a|\mathbf{x}_{1:t+\delta}) &= \text{softmax}(\mathbf{W}_{hy} \mathbf{h}_{t+\delta} + \mathbf{b}_{hy})_a \, \forall \, a \in \mathcal{A}
\end{align}
</div>
